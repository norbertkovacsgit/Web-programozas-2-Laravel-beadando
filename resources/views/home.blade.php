        ...
        <div class="row gtr-50">
            <div class="col-8 col-12-narrower">
                ...
                <footer>
                    <ul class="buttons">
                        <li>
                            <a href="{{ route('races.index') }}" class="button">Versenyek</a>
                        </li>
                    </ul>
                </footer>
            </div>
        ...
        <div class="row">
            <div class="col-6 col-12-narrower">
                <section>
                    ...
                    <a href="{{ route('races.index') }}" class="image featured">
                        <img src="{{ asset('images/monaco_map.jpeg') }}" alt="" />
                    </a>
                    <p>
            ...
            <div class="col-6 col-12-narrower">
                <section>
                    ...
                    <a href="{{ route('races.index') }}" class="image featured">
                        <img src="{{ asset('images/monza_map.jpg') }}" alt="" />
                    </a>
                    <p>
        ...
        <div class="row">
            <div class="col-6 col-12-narrower">
                <section>
                    ...
                    <a href="{{ route('races.index') }}" class="image featured">
                        <img src="{{ asset('images/silv_map.jpg') }}" alt="" />
                    </a>
                    <p>
            ...
            <div class="col-6 col-12-narrower">
                <section>
                    ...
                    <a href="{{ route('races.index') }}" class="image featured">
                        <img src="{{ asset('images/spa_map.jpg') }}" alt="" />
                    </a>
                    <p>
...
<section id="cta">
    ...
    <footer>
        <ul class="buttons">
            <li><a href="{{ route('diagram.index') }}" class="button primary">Tovább</a></li>
            <li><a href="{{ route('contact.form') }}" class="button">Üzenetet írok</a></li>
        </ul>
    </footer>
</section>
